...
@WebServlet("/ChiTietDonHangAdmin")
public class ChiTietDonHangAdmin extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = DBConnect.getConnection()) {
            ...
            request.getRequestDispatcher("chitietdonhangAd.jsp").forward(request, response);
        } catch (Exception e) {
